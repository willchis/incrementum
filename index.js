const KEYCODE_ENTER = 13;		//usefull keycode
const KEYCODE_SPACE = 32;		//usefull keycode
const KEYCODE_UP = 38;		//usefull keycode
const KEYCODE_LEFT = 37;		//usefull keycode
const KEYCODE_DOWN = 40;		//usefull keycode
const KEYCODE_RIGHT = 39;		//usefull keycode
const KEYCODE_W = 87;			//usefull keycode
const KEYCODE_A = 65;			//usefull keycode
const KEYCODE_D = 68;			//usefull keycode
const KEYCODE_S = 83;			//usefull keycode

let spaceTapped;			//did the user tap space
let lfHeld;				//is the user holding the left command
let rtHeld;				//is the user holding the right command
let upHeld;			//is the user holding the up command
let dnHeld;			//is the user holding the down command
let spaceHeld;		// has the user pressed space
